    ...
    try {
                      ...
                      },
                      {
                        table: {
                          ...
                          body: [
                            [
                              {
                                text: 'AUTORIZACIÓN DE INHUMACIÓN',
                                style: 'tableLabel',
                                alignment: 'center',
                                bold: true,
                                valign: 'middle',
                              ...
                              {
                                text:
                                  requisitos?.inhumacion?.codigo_inhumacion ||
                                  '',
                                alignment: 'center',
                                style: 'tableLabel',
                                bold: true,
                        ...
                        table: {
                          ...
                          body: [
                            ...
                            [
                              ...
                              {
                                text:
                                  requisitos?.metodoSolicitud === 'Escrita'
                                    ? 'X'
                                    : '',
                                alignment: 'center',
                              },
                            ...
                            [
                              ...
                              {
                                text: 'Verbal (solo en caso de emergencia)',
                                bold: true,
                                valign: 'middle',
                              },
                              {
                                text:
                                  requisitos?.metodoSolicitud === 'Verbal'
                                    ? 'X'
                                    : '',
                                alignment: 'center',
                              },
                        ...
                        table: {
                          ...
                          body: [
                            [
                              ...
                              {
                                text: 'D) CHECK LIST DE REQUISITOS',
                                bold: true,
                                alignment: 'center',
                                colSpan: 2,
                                valign: 'middle',
                            ...
                            [
                              ...
                              {
                                text: `${requisitos?.solicitante?.nombres?.toUpperCase() || ''} ${requisitos?.solicitante?.apellidos?.toUpperCase() || ''}`,
                                valign: 'middle',
                                border: [false, true, true, true],
                              },
                              {
                                text: '  Copia del certificado de defunción JRC',
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: requisitos?.copiaCertificadoDefuncion
                                  ? 'X'
                                  : '',
                                alignment: 'center',
                                valign: 'middle',
                              ...
                              {
                                text:
                                  requisitos?.observacionCertificadoDefuncion ||
                                  '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ...
                            [
                              { border: [false, true, false, true], text: '' },
                              {
                                text: '  N° Cédula de identidad',
                                bold: true,
                                valign: 'middle',
                                border: [false, true, true, true],
                              },
                              {
                                text: requisitos?.solicitante?.cedula || '',
                                valign: 'middle',
                              },
                              {
                                text: '  Informe estadístico INEC',
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: requisitos?.informeEstadisticoINEC
                                  ? 'X'
                                  : '',
                                alignment: 'center',
                                valign: 'middle',
                              ...
                              {
                                text:
                                  requisitos?.observacionInformeEstadisticoINEC ||
                                  '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ...
                            [
                              ...
                              {
                                text:
                                  requisitos?.solicitante?.direccion?.toUpperCase() ||
                                  '',
                                rowSpan: 2,
                                valign: 'middle',
                              },
                              {
                                text: 'Copia de C.I. del solicitante',
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: requisitos?.copiaCedula ? 'X' : '',
                                alignment: 'center',
                                valign: 'middle',
                              },
                              {
                              ...
                              {
                                text: requisitos?.observacionCopiaCedula || '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ],
                            ...
                            [
                              ...
                              {
                                text: 'Pago de tasa por inhumación',
                                alignment: 'left',
                              },
                              {
                                text: requisitos?.pagoTasaInhumacion ? 'X' : '',
                                alignment: 'center',
                                valign: 'middle',
                              },
                              {
                                text: !requisitos?.pagoTasaInhumacion
                                  ? 'X'
                                  : '',
                                alignment: 'center',
                                valign: 'middle',
                              ...
                              {
                                text:
                                  requisitos?.observacionPagoTasaInhumacion ||
                                  '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ...
                            [
                              ...
                              {
                                text: 'Copia del T. de propiedad del nicho/fosa/sitio',
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: requisitos?.copiaTituloPropiedadNicho
                                  ? 'X'
                                  : '',
                                alignment: 'center',
                                valign: 'middle',
                              ...
                              {
                                text:
                                  requisitos?.observacionCopiaTituloPropiedadNicho ||
                                  '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ...
                            [
                              ...
                              {
                                text: requisitos?.observacionSolicitante || '',
                                rowSpan: 2,
                                valign: 'middle',
                              },
                              {
                                text: 'Autorización de Movilización del Cadáver',
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: requisitos?.autorizacionDeMovilizacionDelCadaver
                                  ? 'X'
                                  : '',
                                alignment: 'center',
                                valign: 'middle',
                              ...
                              {
                                text:
                                  requisitos?.observacionAutorizacionMovilizacion ||
                                  '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ...
                            [
                              ...
                              {
                                text: requisitos?.OficioDeSolicitud ? 'X' : '',
                                alignment: 'center',
                                valign: 'middle',
                              },
                              {
                              ...
                              {
                                text:
                                  requisitos?.observacionOficioSolicitud || '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ],
                        ...
                        table: {
                          ...
                          body: [
                            ...
                            [
                              ...
                              {},
                              {
                                text: `${requisitos?.propietarioNicho?.find((p: any) => p.activo == true)?.id_persona?.nombres || ''} ${requisitos?.propietarioNicho?.find((p: any) => p.activo == true)?.id_persona?.apellidos || ''}`
                                  .toUpperCase()
                                  .trim(),
                                colSpan: 2,
                              },
                            ...
                            [
                              ...
                              {
                                text:
                                  requisitos?.nicho?.id_cementerio?.nombre?.toUpperCase() ||
                                  '',
                                alignment: 'left',
                              },
                            ],
                            ...
                            [
                              ...
                              {
                                text: (
                                  requisitos?.nombreAdministradorNicho || ''
                                ).toUpperCase(),
                                colSpan: 2,
                              },
                              {},
                            ...
                            [
                              ...
                              {
                                text:
                                  requisitos?.propietarioNicho?.[0]?.tipo ===
                                  'Arrendado'
                                    ? 'X'
                                    : '',
                                alignment: 'center',
                              ...
                              {
                                text: 'Firma de aceptación de sepultura',
                                bold: true,
                              },
                              {},
                            ],
                        ...
                        table: {
                          ...
                          body: [
                            ...
                            [
                              ...
                              {
                                text: `${requisitos?.fallecido?.nombres?.toUpperCase() || ''} ${requisitos?.fallecido?.apellidos?.toUpperCase() || ''}`,
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: 'N° de Cédula de identidad',
                                bold: true,
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: requisitos?.fallecido?.cedula || '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ],
                            ...
                            [
                              ...
                              {
                                text:
                                  requisitos?.fallecido?.causa_defuncion || '',
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                              ...
                              {
                                text: (
                                  requisitos?.fallecido?.nacionalidad || ''
                                ).toUpperCase(),
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ...
                            [
                              ...
                              {
                                text: this.formatearFechaLarga(
                                  requisitos?.fallecido?.fecha_nacimiento || '',
                                ),
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: 'Fecha de Inhumación',
                                bold: true,
                                alignment: 'left',
                                valign: 'middle',
                              },
                            ...
                            [
                              ...
                              {
                                text: this.formatearFechaLarga(
                                  requisitos?.fallecido?.fecha_defuncion || '',
                                ),
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: 'Hora de Inhumación',
                                bold: true,
                                alignment: 'left',
                                valign: 'middle',
                              },
                              {
                                text: this.formatearHora(
                                  requisitos?.horaInhumacion || '',
                                ),
                                alignment: 'left',
                                valign: 'middle',
                              },
                        ...
                        table: {
                          ...
                          body: [
                            ...
                            [
                              ...
                              { text: ' ', border: [] },
                              {
                                text: `${requisitos?.fallecido?.nombres || ''} ${requisitos?.fallecido?.apellidos || ''}`,
                                alignment: 'center',
                                margin: [0, 0, 0, 5],
                                border: [false, false, false, false],
                              },
                            ...
                            [
                              ...
                              {
                                text: 'Directora de Servicios Públicos',
                                colSpan: 5,
                                alignment: 'center',
                                border: [false, false, false, false],
                                margin: [0, 0, 0, 0],
      ...
      if (!requisitos?.id_requsitoInhumacion) {
        return Promise.reject(
          'No se puede generar el nombre del PDF: ID de requisito inválido',
        );
      }

      const pdfPath = path.resolve(
        pdfDir,
        `inhumacion_${requisitos.id_requsitoInhumacion}.pdf`,
      );
