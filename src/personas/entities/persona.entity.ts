...
export class Persona {
  ...
  @OneToMany(
    () => PropietarioNicho,
    (propietarioNicho) => propietarioNicho.id_persona,
  )
  ...
  @OneToMany(
    ...
    (requisitosInhumacion) => requisitosInhumacion.id_fallecido,
  )
  requisitos_inhumacion: RequisitosInhumacion[];

  @OneToMany(
    () => RequisitosInhumacion,
    (requisitosInhumacion) => requisitosInhumacion.id_solicitante,
  )
