...
export class PersonasController {
  ...
  @ApiOperation({
    ...
    description:
      'Busca personas por cédula, nombres o apellidos. Opcionalmente filtra por estado vivo/fallecido.',
  })
  @ApiQuery({
    name: 'query',
    required: false,
  ...
  @ApiQuery({
    ...
    type: Boolean,
    description:
      'Filtrar por estado: true=vivos, false=fallecidos, sin especificar=todos',
  })
  @ApiOkResponse({
