...
export class RequisitosInhumacion {
  ...
  @ManyToOne(
    () => Cementerio,
    (cementerio) => cementerio.requisitos_inhumacion,
    { eager: true },
  )
  ...
  @ManyToOne(
    () => Persona,
    (persona) => persona.requisitos_inhumacion_solicitante,
    { eager: true },
  )
  ...
  @ManyToOne(
    () => HuecosNicho,
    (huecosNicho) => huecosNicho.requisitos_inhumacion,
    { eager: true },
  )
  ...
  @OneToOne(
    () => Inhumacion,
    (inhumacion) => inhumacion.id_requisitos_inhumacion,
    { eager: true },
  )
