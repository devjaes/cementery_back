...
export class PropietariosNichosController {
  constructor(
    private readonly propietariosService: PropietariosNichosService,
  ) {}

  @Post()
  // @UseGuards(JwtAuthGuard, RolesGuard)
  @ApiOperation({
    summary: 'Crear nuevo propietario de nicho',
    description: 'Registra una nueva relación de propiedad de nicho',
  })
  ...
  @Get()
  @ApiOperation({
    summary: 'Listar todos los propietarios de nichos',
    description: 'Obtiene todos los registros de propietarios de nichos',
  })
  @ApiOkResponse({
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Obtener propietario de nicho por ID',
    description: 'Obtiene un registro específico de propietario de nicho',
  })
  @ApiParam({
    name: 'id',
    description: 'ID del propietario de nicho',
    type: String,
  })
  @ApiOkResponse({
  ...
  @ApiOperation({
    summary:
      'Obtener propietarios de nicho por ID de nicho, solo los que esten activos',
    description:
      'Obtiene todos los registros de propietarios de nicho por ID de nicho que esten activos',
  })
  ...
  @ApiOperation({
    summary: 'Obtener propietarios de nicho por ID de nicho',
    description: 'Obtiene todos los registros de propietarios de nicho por ID',
  })
  @ApiParam({ name: 'idNicho', description: 'ID del nicho', type: String })
  @ApiOkResponse({
    description: 'Lista de propietarios de nicho obtenida exitosamente',
  ...
  @ApiOperation({
    summary: 'Obtener propietarios de nicho por la cedula del propietario',
    description:
      'Obtiene el registro del propietario que sea buscado por su cedula y el nicho al que es dueño',
  })
  ...
  // @UseGuards(JwtAuthGuard, RolesGuard)
  @ApiOperation({
    summary: 'Actualizar propietario de nicho',
    description: 'Actualiza parcialmente un registro de propietario de nicho',
  })
  @ApiParam({
    name: 'id',
    description: 'ID del propietario de nicho a actualizar',
    type: String,
  })
  ...
  // @UseGuards(JwtAuthGuard, RolesGuard)
  @ApiOperation({
    summary: 'Eliminar propietario de nicho',
    description: 'Elimina permanentemente un registro de propietario de nicho',
  })
  @ApiParam({
    name: 'id',
    description: 'ID del propietario de nicho a eliminar',
    type: String,
  })
