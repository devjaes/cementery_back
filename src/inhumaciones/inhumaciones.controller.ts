...
export class InhumacionesController {
  ...
  @ApiOperation({
    ...
    description:
      'Actualiza completamente la información de una inhumación existente',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    summary:
      'Buscar información de fallecido, sus huecos, nichos y cementerios por cédula',
  })
  @ApiParam({
    name: 'cedula',
    description: 'Cédula del fallecido',
    example: '1234567890',
  })
  ...
  @ApiOperation({
    summary:
      'Buscar inhumaciones por cédula del solicitante, solo si la inhumación tiene un requisito vinculado',
  })
  @ApiParam({
    name: 'cedula',
    description: 'Cédula del solicitante',
    example: '1234567890',
  })
  @ApiOkResponse({ description: 'Inhumaciones encontradas' })
  @ApiNotFoundResponse({
    description: 'Solicitante o inhumaciones no encontradas',
  })
  ...
  @ApiOperation({
    summary:
      'Buscar fallecidos en inhumaciones por cédula, nombres o apellidos (búsqueda parcial)',
  })
  @ApiParam({
    name: 'busqueda',
    example: 'Pablo',
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de fallecidos encontrados en inhumaciones',
  })
